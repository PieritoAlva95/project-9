  ...
  const columns = [
    ...
    },
    {
      ...
      formatter: (cellContent, row) => {
        if (row.activo) {
          return (
            <button style={estiloBtnDelete} onClick={() => desactivar(row)}>
              Desactivar
            </button>
          );
        } else {
          return (
            <button style={estiloAdmin} onClick={() => activar(row)}>
              Activar
            </button>
          );
        }
    ...
    },
    {
      ...
      formatter: (cellContent, row) => {
        if (row.esAdmin) {
          return (
            <button style={estiloAdmin} onClick={() => noHacerAdmin(row)}>
              Administrador
            </button>
          );
        } else {
          return (
            <button style={estiloUser} onClick={() => hacerAdmin(row)}>
              Usuario
            </button>
          );
        }
