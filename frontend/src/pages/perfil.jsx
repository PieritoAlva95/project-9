        ...
        <Fragment>
            <div className="container main-perfil">
                <div className="perfil">
                    ...
                    <a className="contactame" href={linkwhatsapp + user.numeroDeCelular} target="_blank" rel="noreferrer">Contactame!</a>
                    <div className="redes-sociales">
                        {
                            user.redesSociales.facebook ?
                                <a href={user.redesSociales.facebook} target="_blank" rel="noreferrer"><i className='bx bxl-facebook-square' ></i></a>
                                :
                                <span></span>
                        }
                        {
                            user.redesSociales.instagram ?
                                <a href={user.redesSociales.instagram} target="_blank" rel="noreferrer"><i className='bx bxl-instagram' ></i></a>
                                :
                                <span></span>
                        }
                        {
                            user.redesSociales.twitter ?
                                <a href={user.redesSociales.twitter} target="_blank" rel="noreferrer"><i className='bx bxl-twitter' ></i></a>
                                :
                                <span></span>
                        }
                        {
                            user.redesSociales.linkedin ?
                                <a href={user.redesSociales.linkedin} target="_blank" rel="noreferrer"><i className='bx bxl-linkedin-square' ></i></a>
                                :
                                <span></span>
                        }
                    </div>
