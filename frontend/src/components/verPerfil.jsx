            ...
            <div className='container main-perfil'>
              <div className='perfil'>
                ...
                <a
                  ...
                  href={linkwhatsapp + user.usuarioDB.numeroDeCelular}
                  target='_blank'
                  rel='noreferrer'
                >
                  Contactame!
                    ...
                    <div className="col-10">
                        <div className="container main-perfil">
                            <div className="perfil">
                                ...
                                <a className="contactame" href={linkwhatsapp + user.usuarioDB.numeroDeCelular} target="_blank" rel="noreferrer">Contactame!</a>
                                <div className="redes-sociales">
                                    {
                                        user.usuarioDB.redesSociales.facebook ?
                                            <a href={user.usuarioDB.redesSociales.facebook} target="_blank" rel="noreferrer"><i className='bx bxl-facebook-square' ></i></a>
                                            :
                                            <span></span>
                                    }
                                    {
                                        user.usuarioDB.redesSociales.instagram ?
                                            <a href={user.usuarioDB.redesSociales.instagram} target="_blank" rel="noreferrer"><i className='bx bxl-instagram' ></i></a>
                                            :
                                            <span></span>
                                    }
                                    {
                                        user.usuarioDB.redesSociales.twitter ?
                                            <a href={user.usuarioDB.redesSociales.twitter} target="_blank" rel="noreferrer"><i className='bx bxl-twitter' ></i></a>
                                            :
                                            <span></span>
                                    }
                                    {
                                        user.usuarioDB.redesSociales.linkedin ?
                                            <a href={user.usuarioDB.redesSociales.linkedin} target="_blank" rel="noreferrer"><i className='bx bxl-linkedin-square' ></i></a>
                                            :
                                            <span></span>
                                    }
                                </div>
                                ...
                                <div className="skills">
                                    ...
                                    {
                                        user.usuarioDB.skills.map(skill => (
                                            <span className="habilidad"><i className='bx bxs-check-square' ></i> {skill}</span>
                                        ))
                                    }
                                </div>
                            </div>
